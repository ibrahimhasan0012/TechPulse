...
export const ARTICLES = [
    ...
    },
    {
        ...
        category: 'Hardware',
        title: "Samsung Galaxy S26 Ultra: Everything New at Galaxy Unpacked 2026",
        excerpt:
            "Samsung pulled the wraps off the Galaxy S26 Ultra at its February 2026 Galaxy Unpacked event, bringing a slimmer build, a wider camera aperture, a Privacy Display, and a global Snapdragon 8 Elite Gen 5 chip. Here's a full breakdown of what's new.",
        author: 'Ibrahim Hassan',
        authorBio: 'Ibrahim covers mobile hardware and consumer tech at TechPulse.',
        date: 'Feb 27, 2026',
        readTime: '5 min read',
        ...
        content: [
            {
                type: 'lead',
                text: "Samsung's Galaxy Unpacked 2026 delivered exactly what the rumour mill had been predicting for months. The Galaxy S26 Ultra steps up with a thinner frame, a dramatically improved camera system, a first-of-its-kind Privacy Display, and an across-the-board Snapdragon 8 Elite Gen 5 chip — no Exynos variant for the Ultra this year. Here's what you need to know.",
            },
            {
                type: 'image',
            ...
            {
                type: 'h2',
                text: 'Thinner, Lighter, and More Refined',
            },
            {
                type: 'paragraph',
                text: "Samsung has trimmed the S26 Ultra down to just 7.9mm — a noticeable step down from its predecessor — while keeping the weight at a manageable 214g. The corners are more rounded this year and the chamfered edges are softer, giving the phone a less angular feel in the hand. It's a subtle but meaningful design evolution that moves the Ultra line closer to the mainstream Galaxy S aesthetic. The frame is aluminium throughout, and Corning Gorilla Armor 2 glass sits on top of the display.",
            },
            {
                type: 'h2',
                text: 'The Privacy Display Is a Genuine First',
            },
            {
                type: 'paragraph',
                text: "The headline display feature on the S26 Ultra isn't its resolution or refresh rate — it's the built-in Privacy Display mode. Activate it and the screen becomes nearly invisible at wide angles, blocking prying eyes without the need for a stick-on privacy screen protector. The underlying panel is a 6.9-inch Super AMOLED with a 3120 × 1440 resolution and a 120Hz LTPO adaptive refresh rate. Samsung says this is also the brand's first 10-bit main display on an Ultra model, bringing a measurably wider colour volume versus the S25 Ultra's 8-bit screen.",
            },
            {
                type: 'image',
            ...
            {
                type: 'h2',
                text: 'Camera: Wider Aperture, Smarter AI',
            },
            {
                type: 'paragraph',
                text: "The 200MP primary sensor returns, but now ships with an f/1.4 aperture — up from the f/1.7 on the S25 Ultra. That wider opening admits significantly more light per frame, and Samsung says low-light shots have improved dramatically as a result. The periscope telephoto is a 50MP sensor with 5× optical zoom and 10× optical-quality zoom. An ultrawide rounds out the rear array. On the AI side, Photo Assist now accepts plain-text editing instructions ('remove the person on the left', 'make the sky more dramatic'), Audio Eraser has expanded to handle more noise types, and Now Nudge surfaces contextual suggestions proactively throughout the OS.",
            },
            {
                type: 'paragraph',
                text: "Samsung is also introducing APV — a new professional-grade video codec — to the S26 Ultra. It combines efficient compression with high-quality output, making the phone a more capable tool for on-device video production workflows. Samsung emphasized that the most sensitive AI processing runs locally, on-device, to protect user data.",
            },
            {
                type: 'h2',
                text: 'Snapdragon 8 Elite Gen 5 — Everywhere',
            },
            {
                type: 'paragraph',
                text: "For the Ultra, at least, Samsung has committed to a single chipset worldwide: the Qualcomm Snapdragon 8 Elite Gen 5 for Galaxy. The standard S26 and S26+ will use Exynos 2600 in select markets, but the Ultra avoids that split entirely. RAM options go up to 16GB on the 512GB model and 20GB on the 1TB variant. There's also a new 2TB configuration for the first time in the S-series lineup.",
            },
            {
                type: 'h2',
                text: 'Battery: Same Size, Faster Charging',
            },
            {
                type: 'paragraph',
                text: "The 5,000mAh battery is unchanged in capacity, but Samsung has upgraded wired charging to 60W — allowing you to hit 70% in roughly 30 minutes. Wireless charging jumps to 25W (up from 15W on the S25 Ultra), and the phone now supports Qi2 for magnetic accessories. Bluetooth 6.1 also makes its debut here, improving connection stability and enabling more precise location tracking with compatible accessories.",
            },
            {
                type: 'specs',
                title: 'Samsung Galaxy S26 Ultra — Key Specs',
                items: [
                    ['Display', '6.9\" QHD+ LTPO AMOLED, 120Hz, Privacy Display, 10-bit'],
                    ['Chipset', 'Snapdragon 8 Elite Gen 5 for Galaxy (global)'],
                    ['RAM / Storage', '12GB/256GB · 16GB/512GB · 20GB/1TB · 20GB/2TB'],
                    ['Main Camera', '200MP, f/1.4 aperture'],
                    ['Telephoto', '50MP, 5× optical / 10× optical-quality zoom'],
                    ['Battery', '5,000mAh, 60W wired, 25W wireless, Qi2'],
                    ['OS', 'Android 16, One UI 8.5'],
                    ['Build', '7.9mm thin, 214g, Gorilla Armor 2'],
                    ['Availability', 'March 11, 2026 · From $1,299 / £1,279'],
                ],
            },
            {
                type: 'h2',
            ...
            {
                type: 'paragraph',
                text: "The Galaxy S26 Ultra goes on sale March 11, 2026. Pricing starts at $1,299 / £1,279 for the 256GB base configuration. Samsung is offering pre-order bonuses including storage upgrades and trade-in credits through its own channels and major carriers. Colour options at launch are Titanium Black, Titanium Silver Blue, Titanium Gray, and Titanium White Silver.",
            },
            {
                type: 'paragraph',
                text: "We'll have a full hands-on and our in-depth review live on TechPulse closer to the March 11 street date. Stay tuned.",
            },
        ],
    },
    {
